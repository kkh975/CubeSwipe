...
( function( $ ){
	...
	$.fn.cubeSwipe = function( option ){
		...
		return this.each( function(){
			$( this ).data( 'cubeSwipe', new CubeSwipe( option ));
		});
	};
	 ...
	 */
	$.fn.cubeSwipe2start = function(){
		return this.each( function(){
			$( this ).data( 'cubeSwipe' ).startSlideShow();
		});
	};
	 ...
	 */
	$.fn.cubeSwipe2stop = function(){
		return this.each( function(){
			$( this ).data( 'cubeSwipe' ).stopSlideShow();
		});
	};
	 ...
	 */
	$.fn.cubeSwipe2prev = function(){
		return this.each( function(){
			$( this ).data( 'cubeSwipe' ).toPrev();
		});
	};
	 ...
	 */
	$.fn.cubeSwipe2next = function(){
		return this.each( function(){
			$( this ).data( 'cubeSwipe' ).toNext();
		});
	};
	 ...
	 * @method: 슬라이드 제거
	 */       
	$.fn.cubeSwipe2destory = function( _idx ){
		return this.each( function(){
			$( this ).data( 'cubeSwipe' ).destory();
		});
	};
}( jQuery ));
